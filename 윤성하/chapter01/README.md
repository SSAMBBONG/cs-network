...
![Pasted image 20240504141433.png](../img/Pasted image 20240504141433.png)
...
![Pasted image 20240504184653.png](../img/Pasted image 20240504184653.png)
...
![Pasted image 20240504185048.png](../img/Pasted image 20240504185048.png)
...
- 회선 교환
  ...
  - 회선 스위치를 통해 호스트 사이 일대일 전송로를 확보한다.
    ![Pasted image 20240504232737.png](../img/Pasted image 20240504232737.png)
...
- 패킷 교환
  ...
  - 정해진 경로가 없음
    ...
    - 네트워크 장비: 라우터, 스위치
      ![Pasted image 20240504234334.png](../img/Pasted image 20240504234334.png)
...
![Pasted image 20240505002635.png](../img/Pasted image 20240505002635.png)

<hr>
## 네트워크 참조(계층) 모델
>통신이 일어나는 각 과정을 계층으로 나눈 구조
![Pasted image 20240505010538.png](../img/Pasted image 20240505010538.png)
### OSI 모델
- 네트워크를 이론적으로 기술(이상적)
![Pasted image 20240505004134.png](../img/Pasted image 20240505004134.png)
...
- 구현에 중점을 둔 네트워크 참조 모델 (실용적)
  ![Pasted image 20240505005956.png](../img/Pasted image 20240505005956.png)
...
![Pasted image 20240505011514.png](../img/Pasted image 20240505011514.png)
...
- 각 계층에서는 상위 계층으로부터 내려받은 패킷을 페이로드로 삼아, 프로토콜에 걸맞은 헤더(혹은 트레일러)를 덧붙인 후 하위 계층으로 전달 (상위 계층의 패킷은 하위 계층에서의 페이로드로 간주)
  ![Pasted image 20240505011845.png](../img/Pasted image 20240505011845.png)

## 역캡슐화

- 수신할 때 캡슐화 과정에서 붙였던 헤더(및 트레일러)를 각 계층에서 확인한 뒤 제거하는 과정

![Pasted image 20240505011317.png](../img/Pasted image 20240505011317.png)
